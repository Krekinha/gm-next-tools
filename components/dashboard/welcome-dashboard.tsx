...
const featuredTools = [
  {
    ...
    description: "Realize cálculos complexos, conversões de unidades e operações matemáticas avançadas",
    icon: Calculator,
  ...
  },
  {
    ...
    description: "Crie relatórios automatizados com templates personalizáveis e exportação múltipla",
    icon: FileText,
